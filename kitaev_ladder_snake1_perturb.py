    ...
    def init_terms(self, model_params):
        ...
        if S==0.5:
            ...
            for u1, u2, dx in self.lat.pairs['nearest_neighbors_z']:
                ...
                self.add_coupling(h, u1, 'Sigmax', u2, 'Sigmax', dx)# This is the perturbation for breaking Z
            ...
            for u1, u2, dx in self.lat.pairs['nearest_neighbors_z']:
                ...
                self.add_coupling(h, u1, 'Sx', u2, 'Sx', dx)# This is the perturbation for breaking Z
...
def naming(
    ...
    return "KitaevLadderPerturb"+"_chi_"+str(chi)+"_Jx_"+str(Jx)+"_Jy_"+str(Jy)+"_Jz_"+str(Jz)+"_g_"+str(g)+"_h_"+str(h)+"_L_"+str(L)
...
def full_path(
    ...
    **kwargs):
    return prefix+naming(chi, Jx, Jy, Jz,g, h, L)+suffix
...
def load_data(
    ...
    file_name = full_path(chi, Jx, Jy, Jz, g, h, L, prefix=prefix, suffix='.h5')
