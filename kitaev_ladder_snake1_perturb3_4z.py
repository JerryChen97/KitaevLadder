    ...
    def init_terms(self, model_params):
        ...
        if S==0.5:
            ...
            for u1, u2, dx in self.lat.pairs['nearest_neighbors_y']:
                ...
                self.add_coupling(g, u1, 'Sigmaz', u2, 'Sigmaz', dx, op_string='Sigmaz', str_on_first=False)# This is the perturbation for breaking Z      
            ...
            for u1, u2, dx in self.lat.pairs['nearest_neighbors_y']:
                ...
                self.add_coupling(g, u1, 'Sz', u2, 'Sz', dx, op_string='Sz', str_on_first=False)# This is the perturbation for breaking Z   
            for u1, u2, dx in self.lat.pairs['nearest_neighbors_z']:
...
def naming(
    ...
    return "KitaevLadderPerturb3_Z4"+"_chi_"+str(chi)+"_Jx_"+str(Jx)+"_Jy_"+str(Jy)+"_Jz_"+str(Jz)+"_g_"+str(g)+"_L_"+str(L)
...
def full_path(
    ...
    **kwargs):
    return prefix+naming(chi, Jx, Jy, Jz,g, L)+suffix
...
def load_data(
    ...
    file_name = full_path(chi, Jx, Jy, Jz, g, L, prefix=prefix, suffix='.h5')
